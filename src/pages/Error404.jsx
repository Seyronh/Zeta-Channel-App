...
const Error404 = () => {
    ...
    return (
        <div className="bg-blue pt-15">
            ...
            <div>
                <Link className="absolute top-20 left-8 mx-auto pt-6 cursor-pointer flex flex-col" to="/Festival">
                ...
                <Link className="absolute top-20 right-8 mx-auto pt-6 cursor-pointer flex flex-col" to="/Tickets">
                    <div className="relative w-30 h-20 mx-auto">
                ...
                <Link className="relative mt-50  right-0 left-0 mx-auto pt-6 cursor-pointer flex flex-col" to="/Agenda">
                    <div className="relative w-30 h-20 mx-auto">
                ...
                <div className="pt-20 text-center text-white dark:text-black ">
                    <h1 className="text-[10rem] font-bold font-sans">404</h1>
                    ...
                    <p className="text-xl font-sans mt-6 text-balance leading-6">
                        Toca el dinosaurio o pulsa espacio para saltar
                    </p>
                    <Btn to="/" text="Vuelve a probar" className="mt-12 mx-9 mb-20" />
                </div>

                <Link className="relative my-10 ml-40 pt-6 cursor-pointer flex flex-col" to="/Cartelera">
                    <div className="relative w-30 h-20 mx-auto">
                ...
                <Link className="relative bottom-15 -left-30 mx-auto pt-6 cursor-pointer flex flex-col to" to="/User">
                    <div className="relative w-30 h-20 mx-auto">
