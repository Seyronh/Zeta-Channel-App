...
const Home = ({ popupHome, setpopupHome, popupQuepasa, setpopupQuepasa }) => {
    ...
    return (
        <>
            ...
            <section className="mx-auto py-10 gap-16 px-5 flex flex-col">
                <h2 className="text-4xl font-pixel text-black dark:text-white uppercase text-center">¿QUÉ TE APETECE RECORDAR?</h2>
            ...
            <div className="relative w-30 mb-25 py-12 h-20 mx-auto">
            ...
            <section className="flex flex-col mx-6 gap-6 text-black dark:text-white">
                <h2 className="text-4xl font-pixel uppercase text-center">¿Quienes somos?</h2>
                <p>{informacion.parrafo1}</p>
                <p>{informacion.parrafo2}</p>
                <img src={informacion.imagen} alt="Imagen sobre nosotros" className="mx-auto my-6 bg-white overflow-hidden rounded-2xl" />
